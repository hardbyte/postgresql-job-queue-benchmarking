...
Throughput, lift vs baseline, and queue depth. Claim-p95 numbers
omitted — at low worker counts the depth-target producer overshoots
`TARGET_DEPTH` (its backoff polls every ~1 s and the bulk producer
can issue thousands of inserts in that window), so any p95 read off
those rows is queueing wait, not engine claim time. Tracked under
[#8](https://github.com/hardbyte/postgresql-job-queue-benchmarking/issues/8).

| System | Workers | Bulk throughput | Δ vs baseline | Queue depth |
|---|---:|---:|---:|---:|
| **awa** | 4 | 296 | +220 (+289 %) | 26,700 |
| awa | 16 | 1,204 | +561 (+87 %) | 26,378 |
| awa | 64 | 4,090 | +1,656 (+68 %) | 14,420 |
| awa | 128 | **6,481** | +2,162 (+50 %) | 20,597 |
| **pg-boss** | 4 | 512 | +0 | 2,000 |
| pg-boss | 16 | 2,048 | +0 | 2,000 |
| pg-boss | 64 | 2,944 | +538 (+22 %) | 896 |
| pg-boss | 128 | **2,957** | +321 (+12 %) | 128 |
| **pgque** | 4 | 459 | +258 (+128 %) | 0 |
| pgque | 16 | **490** | +233 (+91 %) | 0 |
| pgque | 64 | 459 | +156 (+52 %) | 0 |
| pgque | 128 | 482 | +207 (+75 %) | 0 |
| **procrastinate** | 4 | 248 | +98 (+66 %) | 15 |
| procrastinate | 16 | **256** | +60 (+30 %) | 26 |
| procrastinate | 64 | 239 | +90 (+60 %) | 23 |
| procrastinate | 128 | 252 | +83 (+49 %) | 34 |
| **river** | 4 | 79 | +2 (+3 %) | 2,051 |
| river | 16 | 307 | +157 (+105 %) | 145 |
| river | 64 | 338 | +55 (+19 %) | 8 |
| river | 128 | **344** | +46 (+15 %) | 6 |
| **oban** | 4 | 261 | +32 (+14 %) | 2 |
| oban | 16 | 253 | +0 | 2 |
| oban | 64 | **265** | +16 (+6 %) | 2 |
| oban | 128 | 264 | +25 (+10 %) | 2 |
